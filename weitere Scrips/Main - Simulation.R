...
v <- rep(100,8)
m <- c(0.5, 0.16, 0.03, 0.02, 0.015, 0.01, 0.008, 0.008)
s_squared <- 0.1*c(0.1, 0.07, 0.01, 0.007, 0.003, 0.002, 0.0013, 0.0008)
epsilon <- rep(0.02, 7)
...
for (SimNr in 1:NumberOfSimulations) {
  GLR <- Generalized_LR_Method(SimulatedData$Triangle[,,SimNr],SimulatedData$volumes[,SimNr], lower_bound_eps = 0.001, upper_bound_eps = 0.10)
